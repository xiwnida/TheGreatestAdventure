...
init:
    ...
    image vorota dvorca = ConditionSwitch(
        "day_time=='True'","Images/Alinor/vorota1.jpg",
        "day_time=='False'","Images/Alinor/vorota2.jpg")
#    image vorota dvorca zakat = "Images/Alinor/vorota2.jpg"
    ...
    #Фоны АКТ
    image vorota dvorca akt = ConditionSwitch(
        "day_time=='True'","Images/Alinor/vorota1akt.jpg",
        "day_time=='False'","Images/Alinor/vorota2akt.jpg")
