...
label alinor_capital_vorota_dvorca:
    ...
    $ buttons('vorota', ['alinor_capital_vorota_dvorca' , 'alinor_capital_vorota_dvorca.garden' , 'alinor_capital_plaza'])
...
label alinor_capital_plaza:
    ...
    $ buttons('ul_plaza', ['alinor_capital_plaza' , 'alinor_capital_pereulok' , 'alinor_capital_vorota_dvorca', '.v_bar', '.gostin']) # Прописать бар и гостиницу
...
label alinor_capital_gorod:
    ...
    $ buttons('trading_area', ['alinor_capital_gorod' , 'alinor_capital_ul_dom' , 'alinor_capital_pereulok', 'alinor_lavka_torgovca', 'vokzal'])
...
label alinor_capital_ul_dom:
    ...
    $ buttons('ul_dom', ['alinor_capital_ul_dom' , 'alinor_capital_vash_dom' , 'alinor_capital_gorod'])
jump alinor_capital_ul_dom
  
#=======================Столица. Дом Джека=================================
label alinor_capital_vash_dom:
    $ location("Alinor", "dom", "alinor_vash_dom", True)
    $ buttons('dom', ['alinor_capital_vash_dom' , 'alinor_capital_dom_spal' , 'alinor_capital_ul_dom'], True)
...
label alinor_capital_dom_spal:
    ...
    $ buttons('dom_spal', ['alinor_capital_dom_spal' , 'alinor_capital_vash_dom' , 'alinor_capital_dom_spal.sleep'], True)
...
label alinor_capital_pereulok:        
    ...
    $ buttons('pereulok', ['alinor_capital_pereulok' , 'alinor_capital_gorod' , 'alinor_capital_plaza', 'alinor_capital_cerkov'])
jump alinor_capital_pereulok
        
#=======================Столица. Церковь=================================
label alinor_capital_cerkov:
    $ location("Alinor", "cerkov", "alinor_stolica") #Заменить музыку!!!!!!!!!!!!!!!
    $ buttons('cerkov', ['alinor_capital_cerkov' , 'alinor_capital_pereulok' , 'alinor_capital_cerkov.v_cerkov', 'alinor_capital_cerkov.les'])
