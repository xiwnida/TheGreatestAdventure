...
init:
    ...
    $ muzika = "Nope" # Эта переменная показывает, какая в данный момент играет музыка.
...
label alinor_vorota_dvorca1:
    ...
    $ result = renpy.imagemap("Images/Alinor/vorota1.jpg", "Images/Alinor/vorota1akt.jpg", [
    (705, 1, 731, 38, "Меню"),
    (285, 255, 490, 503, "Cад"),
...
label alinor_glavn_ul1:
    ...
    $ result = renpy.imagemap("Images/Alinor/ul3.png", "Images/Alinor/ul3akt.png", [
    (705, 1, 731, 38, "Меню"),
    (290, 548, 625, 599, "На площадь"),
    (570, 375, 710, 547, "Ко дворцу")
    ])
    if result == "Меню":
        call call_menu from _call_call_menu_1
    elif result == "На площадь":
        jump alinor_pereulok1
    elif result == "Ко дворцу":
        jump alinor_vorota_dvorca1
jump alinor_glavn_ul1
...
label alinor_pereulok1:
    ...
    $ result = renpy.imagemap("Images/Alinor/ul4.png", "Images/Alinor/ul4akt.png", [
    (705, 1, 731, 38, "Меню"),
    (225, 535, 610, 599, "На площадь"),
    (422, 155, 535, 315, "На главную улицу")
    ])
    if result == "Меню":
        call call_menu from _call_call_menu_2
    elif result == "На площадь":
        jump alinor_gorod1
    elif result == "На главную улицу":
        jump alinor_glavn_ul1
jump alinor_pereulok1
...
label alinor_gorod1: 
    ...
    $ result = renpy.imagemap("Images/Alinor/ul2.png", "Images/Alinor/ul2akt.png", [
    (705, 1, 731, 38, "Меню"),
    (392, 294, 515, 390, "На главную улицу"),
    (192, 500, 643, 599, "К вашему дому")
    ])
    if result == "Меню":
        call call_menu from _call_call_menu_3
...
label alinor_ul_dom1:
    ...
    $ result = renpy.imagemap("Images/Alinor/ul1.png", "Images/Alinor/ul1akt.png", [
    (705, 1, 731, 38, "Меню"),
    (290, 243, 410, 360, "Домой"),
    (440, 247, 557, 365, "На площадь")
    ])
    if result == "Меню":
        call call_menu from _call_call_menu_4
    elif result == "Домой":
...
label alinor_vash_dom1:
    ...
    if result == "Меню":
        call call_menu from _call_call_menu_5
...
label vokzal_night_ograb:
    ...
    j_pohab_close "Ох, это {i}очень{/i} секретная миссия, мне не дозволено говорить о ней. 
    Она настолько важная, что за успешное выполнение король пообещал мне большую награду! И гонорар для выполнения дал!"
    ...
    j_smile_close3 "Я работаю на короля, как вы видете, моя миссия подразумевает много странствий, то есть, другими словами, 
    мне нужно ездить из города в город по {i}государственным{/i} причинам."
    driver1_norm "Хммм..."
